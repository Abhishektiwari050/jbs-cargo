...
export function LeadForm() {
  ...
  if (submitted) {
    return (
      <motion.div 
        ...
        className="bg-[var(--color-surface-light)] border border-[var(--color-brand-blue)]/10 p-8 md:p-10 rounded-3xl text-center max-w-lg mx-auto shadow-2xl"
      >
        <div className="w-16 h-16 md:w-20 md:h-20 bg-[var(--color-brand-blue)] rounded-full flex items-center justify-center mx-auto mb-6">
          <svg className="w-8 h-8 md:w-10 md:h-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          </svg>
        </div>
        <h3 className="text-2xl md:text-3xl font-black text-[var(--color-brand-blue)] mb-4">Quote Requested</h3>
  ...
  return (
    <div className="surface-lift p-6 md:p-12 rounded-[2rem] md:rounded-3xl relative overflow-hidden group">
