        ...
        >
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/about" className="text-gray-300 hover:text-white transition-colors font-medium">Corporate History</Link></li>
              <li><span className="text-gray-500 font-medium cursor-default group relative">Industry Focus <span className="ml-2 text-[9px] bg-white/10 text-gray-400 px-2 py-0.5 rounded-full align-middle font-bold uppercase tracking-wider">Soon</span></span></li>
              <li><span className="text-gray-500 font-medium cursor-default">Careers <span className="ml-2 text-[9px] bg-white/10 text-gray-400 px-2 py-0.5 rounded-full align-middle font-bold uppercase tracking-wider">Soon</span></span></li>
            </ul>
          </div>
