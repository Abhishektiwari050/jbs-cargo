...
const testimonials = [
  {
    quote: "JBS Cargo's reefer infrastructure is unparalleled. Their commitment to 14.2°C precision for our biologics has been a turning point for our supply chain reliability.",
    name: "Dr. Arvin Mehta",
    title: "Supply Chain Director, Global Pharma Corp",
  },
  {
    quote: "The move to ICD Dadri was seamless thanks to the JSB onsite team. Their architectural approach to logistics isn't just a service; it's a competitive advantage.",
    name: "Sarah Chen",
